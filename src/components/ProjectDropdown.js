  ...
  return (
    <div className={`mt-${isMobile ? '24' : '48'}`}>
      <div className="space-y-4">
        ...
        <p className={`text-sm md:text-xl mb-4 ${isMobile ? 'mt-1' : 'mt-3'}`}>These are web-based projects I've completed during my time at IU, and throughout my journey as an incoming Developer at RPG.</p>

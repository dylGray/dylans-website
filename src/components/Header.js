...
const Header = () => {
  return (
    <header className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white p-4 mb-8">
      <button id="theme-toggle" type="button" className="text-gray-900 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
